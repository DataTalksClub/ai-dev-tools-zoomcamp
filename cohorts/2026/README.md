...
> [!NOTE]
> This folder contains a copied snapshot of the 2026 course materials before the current root-level redesign. The live 2026 draft is in the project root and may change while the cohort content is being prepared.
